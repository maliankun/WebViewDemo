package com.inspur.baidutest.activity;
...
import com.inspur.baidutest.R;
import com.inspur.baidutest.util.OkHttpCallback;
import com.inspur.baidutest.util.OkHttpUtils;
...
public class RemoteActivity extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remotewebview);
        ...
        initWebviewSetting();
        OkHttpUtils.get("http://218.207.69.236:6105/devicetopo/api/v1/topoManager/getEmsTopoInfo?subnet_type=province_subnet&city_id=&ems_id=&county_id=&subnet_id=", new OkHttpCallback(){
            @Override
...
//        }
        ...
        //wvCon.loadUrl("http://www.baidu.com");
...
//            bottomSheetDialog.show();
        ...
        public void showNextTopo(String node_city_id,String node_ems_id,String node_subnet_id,String node_subnet_type,String node_county_id){
            Intent newintent = new Intent(mContext,RemoteActivity.class);
