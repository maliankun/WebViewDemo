...
//        link.setName(oneLinkObj.name);
    ...
    searchNodeInfo:function (search_nodeName) {
    	...
    	/* if (highLightArr.length>0) {
    		var nodeId = highLightArr[0];
			var oldNode = this.box.getDataById(nodeId);
			console.log(oldNode);
			console.log("---="+oldNode.getX());
			console.log(oldNode.getY());
			//oldNode.setLocation({x:500,y:600});
			//this.network.centerByLogicalPoint(oldNode.getX(),oldNode.getY());
    	} */
